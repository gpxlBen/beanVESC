    ...
    if (_inputY != nil && thisY != screenMidY) {
        ...
        if (thisY < screenMidY) {
            ...
            colorArray = [NSArray arrayWithObjects:
                          [UIColor clearColor],
                          [UIColor clearColor],
                          [UIColor colorWithRed:0.06 green:0.87 blue:0.14 alpha:(1.0-topY)*0.5],
                          [UIColor clearColor],
            ...
            colorArray = [NSArray arrayWithObjects:
                          [UIColor clearColor],
                          [UIColor clearColor],
                          [UIColor colorWithRed:0.86 green:0.07 blue:0.14 alpha:bottomY*0.5],
                          [UIColor clearColor],
                          [UIColor clearColor], nil];
...
- (CGGradientRef)newGradientWithColors:(NSArray*)colorsArray locations:(NSArray*)locationsArray {
    ...
    NSUInteger count = [colorsArray count];
